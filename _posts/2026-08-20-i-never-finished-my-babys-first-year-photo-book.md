---
title: "I Never Finished My Baby's First Year Photo Book. Here's Why That Wasn't On Me."
description: "I never finished my baby's first year photo book. Not because I didn't have time. Because every single photo felt like the best one."
season: "summer 2026"
---
...
I used to tell myself I'd get to it once things calmed down. They didn't, and also, that wasn't really the problem.

The problem was the picking. Every photo book tool out there hands you the same task: go through your camera roll and choose the best ones. For most things, sure, that's a fair ask. For your own kid's first year, it's an impossible one. The blurry one where she's mid-laugh. The one where the lighting's bad but he's looking right at the camera for the first time. The fortieth nearly identical photo of the same nap in the same onesie. None of them were "the best." They were all the only one of their kind, and I knew it every time I tried to delete one down to a shortlist.

So I didn't. I just closed the app and told myself I'd deal with it later.
...
Looking back, I don't think I needed a nicer app to help me build the photo book. Every tool I tried still handed me the same job with a prettier interface: open the camera roll, scroll, decide what stays and what gets left behind. Photo book technology has gotten better automation and tools for the layout of the photo book, but a smoother UI doesn't fix the typically impossible choice: which of the near-identical two photos of your kid do you print and not print?

What I actually needed was to not be the one who had to choose at all.

That's the whole reason [njuta](http://www.njutabook.com/) exists. It's the seasonal memory book that makes itself, built for everyone whose best moments never leave their camera roll. No uploading, no sorting, no choosing, no work. Your season gets pulled together automatically and shows up at your door, one photo per spread, with space next to each one to write down the date, the place, whatever you actually remember about that ordinary, perfect day.

I built the thing I needed and couldn't find. Which, if you're building anything right now, you already know is usually how it goes.
